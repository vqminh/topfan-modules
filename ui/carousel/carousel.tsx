		...
		>
			...
			<div className="flex items-center w-full absolute top-2/4 z-10">
				<button
					...
					} text-black flex items-center justify-center rounded-full text-gray-0 bg-primary absolute transition duration-250 hover:bg-gray-900 hover:text-white focus:outline-none start-0 transform ${
						dir === "rtl"
				...
				<button
					...
					} text-black flex items-center justify-center rounded-full bg-primary absolute transition duration-250 hover:bg-gray-900 hover:text-white focus:outline-none end-0 transform ${
						dir === "rtl"
							? "rotate-180 shadow-navigationReverse -translate-x-1/2"
							: "shadow-navigation translate-x-1/2"
					}`}
