...
import { fadeInOut } from "@topfan-modules/motion/fade-in-out";
import { zoomOutIn } from "@topfan-modules/motion/zoom-out-in";
import { useUI } from "src/contexts/ui.context";
import useOnClickOutside from "@topfan-modules/utils/use-click-outside";
				...
				{open && (
					...
					>
						<button
							...
							className={cn(
								"fixed z-10 inline-flex items-center justify-center w-7 h-7 md:w-8 md:h-8 rounded-full bg-primary shadow text-gray-600 transition duration-200 focus:outline-none focus:text-gray-800 focus:shadow-md hover:text-gray-800 hover:shadow-md",
