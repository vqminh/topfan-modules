...
const CategoryListCard: React.FC<Props> = ({ category }) => {
	...
	return (
		<Link href={`${ROUTES.CATEGORY}/${category.slug}`}>
			<a className="flex justify-between items-center bg-gray-200 rounded-md px-5 2xl:px-3.5 py-3 xl:py-3.5 2xl:py-2.5 3xl:py-3.5 transition hover:bg-secondary">
