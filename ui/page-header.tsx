...
const PageHeader: React.FC<HeaderProps> = ({
  ...
  useTitle(t(pageHeader));
  return (
    <div
      className="flex justify-center p-6 md:p-10 2xl:p-8 relative bg-no-repeat bg-center bg-cover bg-gradient-to-r from-topfan-blue via-topfan-pink via-topfan-rose to-topfan-purple"
      style={{
