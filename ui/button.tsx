...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  ...
  const rootClassName = cn(
    ...
    {
      "bg-heading text-white px-5 md:px-6 lg:px-8 py-4 md:py-3.5 lg:py-4 hover:text-white hover:bg-topfan-purple hover:shadow-cart":
        variant === "flat",
      "h-11 md:h-12 px-5 bg-heading text-white py-2 transform-none normal-case hover:text-white hover:bg-topfan-purple hover:shadow-cart":
        variant === "slim",
  ...
  if (!!percentage && percentage < 100) {
    return (
      <div className="h-5 md:h-6 relative max-w-xl rounded-full overflow-hidden">
