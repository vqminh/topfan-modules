...
import { heightCollapse } from "@topfan-modules/motion/height-collapse";
...
export const Collapse: React.FC<CollapseProps> = ({
	...
	return (
		<div
			className={cn({
				"rounded-md bg-secondary": variant === "gray",
				"shadow-sm": isOpen,
			})}
		>
			<motion.header
			...
			>
				<h2
					className={cn(
						"text-sm font-semibold leading-relaxed text-primary pe-2",
						{
							"lg:text-lg": variant === "transparent",
						}
					)}
				>
			...
			<AnimatePresence initial={false}>
				{isOpen && (
					...
					>
						<div
							className={cn("pb-6 md:pb-7 leading-7 text-sm text-primary", {
