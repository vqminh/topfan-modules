...
const CookieBar: React.FC<CookieBarProps> = ({
	...
	return (
		<div
			className={cn(
				"text-center p-5 bg-primary text-sm flex-row justify-center items-center font-medium fixed bottom-0 w-full z-30 transition-all duration-300 ease-out shadow-cookies",
				{
					transform: true,
